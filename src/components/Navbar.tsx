...
/* The tone of each mark, stepped along one ramp rather than picked six
   ...
   to be seen at all. */
const navLinks = [
  { label: "Home",       href: "#hero",         tone: "#2e7397", lit: "#fffdf6" },
  { label: "Projects",   href: "#projects",     tone: "#3a746a", lit: "#a9dbe0" },
  { label: "Experience", href: "#experience",   tone: "#47753d", lit: "#c6dcae" },
  { label: "Skills",     href: "#about",        tone: "#4d7526", lit: "#d3dd9c" },
  { label: "Awards",     href: "#achievements", tone: "#3a602b", lit: "#e4d3b8" },
  { label: "Contact",    href: "#contact",      tone: "#274a30", lit: "#eef2cf" },
];
